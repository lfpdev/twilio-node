...
function Twilio(username, password, opts) {
  ...
  if (!opts.lazyLoading) {
    this._httpClient = this.httpClient; // 定义了一堆 get。非懒加载则启动时就全部加载
  }
...
Object.defineProperty(Twilio.prototype,
  'messages', {
    get: function() {
      return this.api.account.messages; // new twilio 的时候 new api（new api 的时候 new account 的时候 new message）
    }
});
